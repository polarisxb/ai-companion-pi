#!/usr/bin/env python3
"""Run the M12.2 semantic retrieval behavior gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the M12.2 semantic retrieval behavior gate")
    ...
    if not args.no_write_report:
        report_path = write_m12_semantic_retrieval_report(paths, report, args.report_file)

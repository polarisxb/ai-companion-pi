#!/usr/bin/env python3
"""Run the M8.7 memory and dialogue final freeze gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run M8.7 memory and dialogue final freeze")
    ...
    if not args.no_write_report:
        report_path = write_m8_memory_freeze_report(paths, report, args.report_file)

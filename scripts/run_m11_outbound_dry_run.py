#!/usr/bin/env python3
"""Run the M11.3 Signal outbound dry-run gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run M11.3 Signal outbound dry run")
    ...
    result = run_m11_outbound_dry_run(paths, write_runtime=not args.no_runtime_writes)
    report = result.to_dict()
    if not args.no_write_report:
        report_path = write_m11_outbound_dry_run_report(paths, report, args.report_file)

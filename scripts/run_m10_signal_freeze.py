#!/usr/bin/env python3
"""Run the M10.5 read-only Signal chat final freeze gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the M10.5 Signal chat final freeze gate")
    ...
    if not args.no_write_report:
        report_path = write_m10_signal_freeze_report(paths, report, args.report_file)

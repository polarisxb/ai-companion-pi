#!/usr/bin/env python3
"""Run the M12.5 read-only semantic retrieval final freeze gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the M12.5 semantic retrieval final freeze gate")
    ...
    if not args.no_write_report:
        report_path = write_m12_semantic_freeze_report(paths, report, args.report_file)
